...
\begin{itemize}[parsep=0.2ex]
  \item 熟练使用C、C++、Lua、Python，具备扎实的服务端开发与问题定位能力
  \item 熟悉skynet、MongoDB、Etcd，具备分布式服务设计与落地经验
...
\textbf{带领服务端组完成三轮测试与公测，服务器运行稳定，项目首日国服最高在线40万，注册用户300万。}

\begin{itemize}
  \item 负责服务端架构设计与核心模块开发，基于skynet从0到1搭建分布式服务器系统，通过Etcd实现服务注册与发现，支持动态扩容
  \item 设计并实现通用属性系统，支持基础属性与自定义属性、嵌套结构、按粒度同步、序列化及分表存档，满足复杂角色数据管理需求
  \item 搭建压测体系并部署压测集群，模拟40W机器人集中登录，集群登录TPS达到4000，据此评估线上集群规模并支撑开服容量方案制定
  \item 主导性能与稳定性优化，包括业务热点治理、数据库分片与索引优化、读写分离、慢日志分析、主从切换支持、内存泄漏排查及Lua热更能力建设
  \item 负责登录、定时任务、聊天等核心系统开发，参与线上部署与维护、代码评审及优化方案推进，推动版本稳定迭代
\end{itemize}

\datedsubsection{\textbf{网易 | 幻书启世录}, 服务端开发}{2019-2021}
\begin{itemize}
  \item 参与战令、商城等系统功能开发与联调，支持版本内容落地
  \item 负责服务端活动玩法开发，配合策划与客户端完成需求实现和上线
  \item 熟悉MobileServer框架及游戏项目开发流程，积累活动系统和版本迭代经验
\end{itemize}
