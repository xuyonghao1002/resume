...
\begin{itemize}[parsep=0.2ex]
  ...
  \item 熟悉Skynet框架、Etcd，具备分布式服务设计与落地经验
  \item 熟悉MongoDB数据库，具备分片、索引优化、读写分离等优化经验
  \item 熟悉压测、性能优化、线上部署与运维，能够支撑高并发业务场景
\end{itemize}
...
\textbf{带领服务端组完成三轮测试与公测，项目首日国服最高在线40W+，注册用户300W+。}
